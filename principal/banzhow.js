...
$(function() {
    ...
    if (!device.mobile() && !device.tablet() && !is_ie7) {
        ...
        $(".section-colored.mapa").css('background-attachment', 'fixed');
        $(".section-colored.mapa").parallax("0%", 0.4);
        $(".section-colored.dog").css('background-attachment', 'fixed');
        $(".section-colored.dog").parallax("0%", 0.4);
        $(".section-colored.salud").css('background-attachment', 'fixed');
        $(".section-colored.salud").parallax("0%", 0.4);
        $(".section-colored.agenda").css('background-attachment', 'fixed');
        $(".section-colored.agenda").parallax("0%", 0.4);
        $(".section-colored.venta").css('background-attachment', 'fixed');
        $(".section-colored.venta").parallax("0%", 0.4);
