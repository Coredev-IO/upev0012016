...
$db['default']['hostname'] = $localsys['db_hostname'];
$db['default']['username'] = $localsys['db_username'];
$db['default']['password'] = $localsys['db_password'];
$db['default']['database'] = $localsys['db_database'];
