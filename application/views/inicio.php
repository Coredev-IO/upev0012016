    ...
    <nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          ?>
          <a class="navbar-brand" href="<?=base_url()?>index.php/index" >petCloud</a>
        </div>
      ...
      <!-- Indicators -->
        ...
        <div class="carousel-inner">
          <div class="item active">
            <div class="fill" style="background-image:url('<?=base_url()?>principal/1.jpg');"></div>
            <div class="carousel-caption">
              <h2>Administra de manera sencilla e intuitiva tu veterinaria</h2>
              <a href="#" class="button">CONOCE MÁS</a>
            </div>
          </div>
          <div class="item">
            <div class="fill" style="background-image:url('<?=base_url()?>principal/2.jpg');"></div>
            <div class="carousel-caption">
              <h2>Todos tus servicios en una sola aplicación</h2>
              <a href="#" class="button">CONOCE MÁS</a>
            </div>
          </div>
          <div class="item">
            <div class="fill" style="background-image:url('<?=base_url()?>principal/3.jpg');"></div>
            <div class="carousel-caption">
              <h2>Acerca a los clientes con la salud de sus masotas con las aplicaciones para Android y iPhone</h2>
              <a href="#" class="button">CONOCE MÁS</a>
            </div>
          </div>
        </div>
...
<div class="section">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4">
            <img src="<?=base_url()?>principal/petcloud.png" width='100%'>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-9 col-sm-8">
            <h2>¿Aún no formas parte de petClud? Regístrate y conoce sus beneficios</h2>
          </div>
          <div class="col-md-3 col-sm-4">
            <a href="#" class="btn btn-danger btn-lg">Crear cuenta petCloud</a>
          </div>
        </div><!-- /.row -->
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html" class="link-portfolio">
              ...
              <img class="img-responsive img-home-portfolio" src="<?=base_url()?>principal/portfolio_1.png" alt="portfolio 1">
            </a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html" class="link-portfolio">
              ...
              <img class="img-responsive img-home-portfolio" src="<?=base_url()?>principal/portfolio_2.png" alt="portfolio 2">
            </a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html" class="link-portfolio">
              ...
              <img class="img-responsive img-home-portfolio" src="<?=base_url()?>principal/portfolio_3.png" alt="portfolio 3">
            </a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html" class="link-portfolio">
              ...
              <img class="img-responsive img-home-portfolio" src="<?=base_url()?>principal/portfolio_4.png" alt="portfolio 4">
            </a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html" class="link-portfolio">
              ...
              <img class="img-responsive img-home-portfolio" src="<?=base_url()?>principal/portfolio_5.png" alt="portfolio 5">
            </a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html" class="link-portfolio">
              ...
              <img class="img-responsive img-home-portfolio" src="<?=base_url()?>principal/portfolio_6.png" alt="portfolio 6">
            </a>
          </div>
        </div><!-- /.row -->
        ...
        <div class="container clients">
          ...
          <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
              <a href="#"><img class="img-responsive" src="<?=base_url()?>principal/client-1.png" alt="client 1"></a>
            </div>

            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
              <a href="#"><img class="img-responsive" src="<?=base_url()?>principal/client-2.png" alt="client 2"></a>
            </div>
            
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
              <a href="#"><img class="img-responsive" src="<?=base_url()?>principal/client-3.png" alt="client 3"></a>
            </div>

            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
              <a href="#"><img class="img-responsive" src="<?=base_url()?>principal/client-4.png" alt="client 4"></a>
            </div>

            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
              <a href="#"><img class="img-responsive" src="<?=base_url()?>principal/client-5.png" alt="client 5"></a>
            </div>

            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
              <a href="#"><img class="img-responsive" src="<?=base_url()?>principal/client-6.png" alt="client 6"></a>
            </div>
          </div><!-- /.row -->
    ...
    <!-- Switcher -->
    <script type="text/javascript" src="<?=base_url()?>principal/switcher.js"></script>
    <link href="<?=base_url()?>principal/switcher.css" rel="stylesheet">
