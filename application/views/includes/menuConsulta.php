  ...
  <p class="card-text">
          <div class="list-group">
                  <?php
                        ...
                        if($evaluacionObj[0]->cn1==1
                                ...
                                && $evaluacionObj[0]->cn13==1){
                                        ...
                                        if(isset($evaluacionObj[0]->idEvaluacion)){
                                                echo '<a class="btn btn-outline-success btn-100" href="'.base_url().'index.php/consultams/finalizarEstadoMed/'.$datos['idEvaluacion'].'">FINALIZAR REVISÓN</a>';
                                        }else{
                                                echo '<a class="btn btn-outline-success btn-100" href="'.base_url().'index.php/consultams/finalizarEstadoMed/'.$datos['idEvaluacion'].'">FINALIZAR REVISÓN</a>';
                                        }
                        ...
                        <a class="btn btn-outline-danger btn-100" href="<?=base_url()?>index.php/consultams/updateEstadoMed/<?=$datos['idEvaluacion']?>'">SOLICITAR CORRECCIÓN</a>
                         <?php
                                }
                                ?>
          </div>
