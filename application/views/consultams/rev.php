        ...
        foreach ($evaluaciones as $row) {
                ...
                switch ($row->estado) {
                        ...
                        case "REV":
                                ...
                                break;
                        case "FIN":
                                echo '<a href="'.base_url().'index.php/consultams/calculo/'.$row->idEvaluacion.'/consulta" class="btn btn-outline-warning">Revisar resultados</a>';
                                echo '<a href="'.base_url().'index.php/consultams/calculo/'.$row->idEvaluacion.'/excel" class="btn btn-info">Generar Excel</a>';
                                break;
                        case "RES":
