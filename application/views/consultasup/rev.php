...
?>
</div><div class="col-md-4"><a href="<?=base_url()?>/index.php/consultasup" class="btn btn-outline-info btn-100">REGRESAR</a></div>
</div>
<hr>
<?php
        ...
        foreach ($evaluaciones as $row) {
                ...
                switch ($row->estado) {
                        ...
                        case "REV":
                                ...
                                break;
                        case "FIN":
                                echo '<a href="'.base_url().'index.php/consultasup/calculo/'.$row->idEvaluacionSup.'" class="btn btn-outline-warning">Confirmar resultados</a>';
                                break;
                        case "RES":
