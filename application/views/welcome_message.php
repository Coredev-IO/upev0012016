...
<html lang="en">
  <head>
    ...
    <!-- Loading Bootstrap -->
    <link href="/petCloud/includes/Flat-UI-master/bootstrap/css/bootstrap.css" rel="stylesheet">

    <!-- Loading Flat UI -->
    <link href="/petCloud/includes/Flat-UI-master/css/flat-ui.css" rel="stylesheet">

    <link rel="shortcut icon" href="/petCloud/includes/Flat-UI-master/images/favicon.ico">
  ...
  <body>
    <div class="container">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Toilet-Paper@2x.png" alt="Toilet-Paper"></div>          
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Gift-Box@2x.png" alt="Gift-Box"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Pensils@2x.png" alt="Pensils"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Clipboard@2x.png" alt="Clipboard"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Retina-Ready@2x.png" alt="Retina-Ready"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Compas@2x.png" alt="Compas"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Map@2x.png" alt="Map"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Chat@2x.png" alt="Chat"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Mail@2x.png" alt="Mail"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Book@2x.png" alt="Book"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Calendar@2x.png" alt="Calendar"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Pocket@2x.png" alt="Pocket"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Watches@2x.png" alt="Watches"></div>
          <div><img src="/petCloud/includes/Flat-UI-master/images/icons/Infinity-Loop@2x.png" alt="Infinity-Loop"></div>
        </div>
      </div>
        ...
        <div class="span8 demo-video">
          <!--[if !IE]> -->
            <video class="video-js" controls
              preload="auto" width="620" height="349" poster="/petCloud/includes/Flat-UI-master/images/video/poster.jpg" data-setup="{}">
      ...
      <div class="row demo-tiles">
        <div class="span3">
          <div class="tile">
            <img src="/petCloud/includes/Flat-UI-master/images/icons/Compas@2x.png" alt="Compas@2x" class="tile-image big-illustration">
        ...
        <div class="span3">
          <div class="tile">
            <img src="/petCloud/includes/Flat-UI-master/images/icons/Infinity-Loop@2x.png" alt="Infinity-Loop@2x" class="tile-image">
        ...
        <div class="span3">
          <div class="tile">
            <img src="/petCloud/includes/Flat-UI-master/images/icons/Pensils@2x.png" alt="Pensils@2x" class="tile-image">
        ...
        <div class="span3">
          <div class="tile tile-hot">
            <img src="/petCloud/includes/Flat-UI-master/images/icons/Chat@2x.png" alt="Chat@2x" class="tile-image">
      ...
      <div class="login">
        <div class="login-screen">
          <div class="login-icon">
            <img src="/petCloud/includes/Flat-UI-master/images/login/icon.png" alt="Welcome to Mail App" />
      ...
      <div class="row">
        <div class="span9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="/petCloud/includes/Flat-UI-master/images/demo/browser-pic-1.jpg" alt="" />
              <img src="/petCloud/includes/Flat-UI-master/images/demo/browser-pic-2.jpg" alt="" />
              <img src="/petCloud/includes/Flat-UI-master/images/demo/browser-pic-3.jpg" alt="" />
              <img src="/petCloud/includes/Flat-UI-master/images/demo/browser-pic-4.jpg" alt="" />
              <img src="/petCloud/includes/Flat-UI-master/images/demo/browser-pic-5.jpg" alt="" />
              <img src="/petCloud/includes/Flat-UI-master/images/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="span3">
          <div class="demo-download">
            <img src="/petCloud/includes/Flat-UI-master/images/demo/html-icon.png" src="Free PSD" />
          </div>
        ...
        <div class="row">
          <div class="span7">
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="/petCloud/includes/Flat-UI-master/images/footer/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /span8 -->
    ...
    <script src="/petCloud/includes/Flat-UI-master/js/jquery-1.8.3.min.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/jquery-ui-1.10.3.custom.min.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/jquery.ui.touch-punch.min.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/bootstrap.min.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/bootstrap-select.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/bootstrap-switch.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/flatui-checkbox.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/flatui-radio.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/jquery.tagsinput.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/jquery.placeholder.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/jquery.stacktable.js"></script>
    <script src="http://vjs.zencdn.net/c/video.js"></script>
    <script src="/petCloud/includes/Flat-UI-master/js/application.js"></script>
  </body>
</html>
