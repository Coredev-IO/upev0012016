<div class="row">
              <div class="col-md-12">
                      <div class="well" id="actionbtn">
                              <a class="btn btn-default" href="<?=base_url()?>index.php/admin/user_reg/newsupcon">Agregar Usuario</a>
                      </div>

                      <div class="well">
                              <div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
                                      <ul id="myTabs" role="tablist" class="nav nav-tabs">
                                              <li role="presentation" class="active"><a id="home-tab" href="#home" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Usuarios para <b>revisón</b> de información de Nivel Superior</a></li>
                                      </ul>
