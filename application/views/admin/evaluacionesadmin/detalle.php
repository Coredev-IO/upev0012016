...
<a class="btn btn-outline-success btn-sm btn-100" href="<?=base_url()?>index.php/admin/nueva_evaluacion_sup/<?=$unidad[0]->idUnidad?>">NUEVA EVALUACIÓN</a>
...
switch ($row->estado) {
        case "ACT":
                echo '<a href="'.base_url().'index.php/admin/cancel_ev_sup/'.$unidad[0]->idUnidad.'/'.$row->idEvaluacionSup.'" class="btn btn-outline-danger btn-sm btn-100">Cancelar</a>';
                break;
        case "REV":
                echo '<a href="'.base_url().'index.php/admin/cancel_ev_sup/'.$unidad[0]->idUnidad.'/'.$row->idEvaluacionSup.'" class="btn btn-outline-danger btn-sm btn-100">Cancelar</a>';
                break;
