...
<div class="row">
                  ...
                  <div class="col-md-6">
                          <div class="form-group">
                                  ...
                                  <input type="text" class="form-control"  placeholder="" name="nombre" maxlength="40" value=<?php echo $usuarios[0]->Nombre?> required onkeypress="return val(event)">
                          </div>
                  </div>
                  <div class="col-md-6">
                          <div class="form-group">
                                  <label for="nombre">Apellido Paterno</label>
                                  <input type="text" class="form-control"  placeholder="" name="apPaterno" maxlength="40" value=<?php echo $usuarios[0]->ApellidoPaterno?> required onkeypress="return val(event)">
                          </div>
                  </div>
                  <div class="col-md-6">
                          <div class="form-group">
                                  <label for="nombre">Apellido Materno</label>
                                  <input type="text" class="form-control"  placeholder="" name="apMaterno" maxlength="40" value=<?php echo $usuarios[0]->ApellidoMaterno?> required onkeypress="return val(event)">
                          </div>
                  </div>
          </div>
          <div class="row">
...
<div class="col-md-6">
                  ...
                  <div class="col-md-6">
                          <div class="form-group">
                                  ...
                                  <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control"  placeholder="" name="tel" value=<?php echo $usuarios[0]->Telefono?> required maxlength="10">
                          </div>
                  </div>
