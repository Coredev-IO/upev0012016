...
foreach ($ServicioApoyo as $row) {
	...
	if ($row["Despegable"]) {
		...
		if ($row["Indicadores"] == "Cumplimiento del programa de mantenimiento") {$varID = "c"; $varID2        = "x";};
		if ($row["Indicadores"] == "Cumplimiento del programa de limpieza") {$varID = "d"; $varID2        = "w";};
		$prinArr                                                           = 0;
